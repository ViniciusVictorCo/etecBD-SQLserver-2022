...
INSERT INTO tbFabricante1(nomeFabricante)
VALUES('Unilever')
,('P&G')
,('Bunge')
...
--exercicio 01 Cadastrar três novos fornecedores via query;
INSERT INTO tbFornecedor (nomeFornecedor)
VALUES	('EXTRA')
		,('CARREFOUR')
		,('COCA-COLA')

--exercicio 02 Fazer uma consulta utilizando o nome do fornecedor e a descrição dos produtos que cada fornecedor fornece;


--exercicio 03 Criar uma instrução utilizando left join e outra utilizando right join para exibir todos os fornecedores,
--incluindo ainda os três novos fornecedores para os quais não foram registrados novos produtos;

--exercicio 04 Cadastrar três novos produtos deixando para eles o código do fornecedor em branco;

--exercicio 05 Criar um select utilizando a instrução full join exibindo assim todos os fornecedores,
--inclusive aqueles para os quais não foram atribuídos produtos,e aqueles produtos para os quais não foram atribuídos fornecedores;

--exercicio 06 Criar um select com a instrução cross join entre fornecedor e produto.Quantos registros a consultar e tornou?O que aconteceu?
